...
type Route01Dto struct {
	ID          int     `json:"id"`
	RtCode      int32   `json:"route_code"` // FK to route.route_code
	RoutedX     float64 `json:"routed_x"`
	RoutedY     float64 `json:"routed_y"`
	RoutedOrder int16   `json:"routed_order"`
}
