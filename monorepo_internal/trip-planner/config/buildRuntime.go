...
import (
	...
	ziputil "github.com/cs161079/monorepo/trip-planner/utils"
	"go.uber.org/dig"
	"gorm.io/gorm"
)
...
func (a App) Boot() {
	...
	logger.INFO("Prepare GTFS Feed ZIP file for OTP.")
	err = ziputil.Zip(
...
func InitializeApplication() {
	...
	various := os.Getenv("VARIOUS")
	logger.Logger.Out.Write([]byte(fmt.Sprintf("Custome Enviroment Variable: %s", various)))
