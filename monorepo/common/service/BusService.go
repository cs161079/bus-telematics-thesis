...
type BusService interface {
	...
	GetBusCapacity(int64, int32) (*models.Bus_Capacity, error)
...
func (s busService) GetBusCapacity(busId int64, routeCode int32) (*models.Bus_Capacity, error) {
	return s.repo.SelectCapacity(busId, routeCode)
}
